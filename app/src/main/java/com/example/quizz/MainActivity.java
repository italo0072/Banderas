...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questiones.add(new question("adivina la bandera","Alemania","El salvador","Alemania","Nicaragua"));
        questiones.add(new question("adivina la bandera","España","Mexico","España","Holanda"));
        questiones.add(new question("adivina la bandera","Corea del sur","Corea del sur","Estados unidos","Argentina"));
        questiones.add(new question("adivina la bandera","China","Chile","Colombia","China"));
